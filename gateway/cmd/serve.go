...
import (
	...
	"github.com/what-da-flac/wtf/gateway/internal/assets"
	...
	"github.com/what-da-flac/wtf/gateway/internal/rest"
	"github.com/what-da-flac/wtf/gateway/internal/senders"
	"github.com/what-da-flac/wtf/gateway/internal/stores"
...
func configureMiddlewares(config *environment.Config, repository interfaces.Repository) ([]models.MiddlewareFunc, error) {
	...
	roleResolver := stores.NewRoleStore(repository)
	userResolver := stores.NewUserStore()
